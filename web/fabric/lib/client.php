	...
	public function set_initial(){
		...
		if($this->initial_set != true){
			...
			if($template == 'control'){
				...
				$new['rel']		 = 'stylesheet';
				$new['title']	 = 'default';
				$new['href']	 = '/css/bootstrap/bootstrap.css';
				$new['media']	 = 'all';
				...
				$new['rel']		 = 'stylesheet';
				$new['title']	 = 'default';
				$new['href']	 = '/css/bootstrap/bootstrap.css.map';
				$new['media']	 = 'all';
				array_push($links, $new);
				...
				$new['rel']		 = 'stylesheet';
				$new['title']	 = 'default';
				$new['href']	 = '/css/sb-admin.css';
				$new['media']	 = 'all';
				array_push($links, $new);
				$new			 = array();
				$new['type']	 = 'text/javascript';
				$new['title']	 = 'default';
				$new['src']		 = '/js/bootstrap/bootstrap.min.js';
