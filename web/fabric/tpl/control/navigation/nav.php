											...
											<div class="panel-body">
												<form method="POST" action="<?php echo lc('uri')->get_uri(); ?>">
													...
													foreach($nav_opt as $opt){
														...
														$sort	 = $opt['sort'];
														?>
														<span class="btn btn-primary edit-nav" id="sort_<?php echo $sort ?>"><?php echo $name ?></span>
														<?php
													}
													?>
													<span class="btn btn-primary edit-nav" id="sort_0">+ Add One...</span>													
													<br style="clear:both" />
													<br style='clear:both' />
													<div class="col-md-6" id='top-menu-edit-container' style='display:none'>
